...
ozone_vod = genfromtxt(
    "../SnowProcessor/2.2/tg_vod.dat", delimiter="   ", skip_header=2
)
...
for i in range(15, 21):
    ...
    compare_plot(
        alb_sph[:, i],
        "../SnowProcessor/2.2/spherical_albedo.dat",
        ("alb_sph" + str(i)),
        4 + i,
    )
...
for i in range(15, 21):
    ...
    compare_plot(
        rp[:, i], "../SnowProcessor/2.2/planar_albedo.dat", ("alb_pl" + str(i)), 4 + i
    )
    input("Press Enter to continue...")
# GOOD
